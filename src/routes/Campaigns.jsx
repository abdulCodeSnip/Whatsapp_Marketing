        ...
        <div className="flex h-screen bg-gray-50">
            ...
            <div className="flex-1 flex flex-col overflow-hidden">
                ...
                <div className="bg-white shadow-sm border-b border-gray-200 px-6 py-4">
                    <div className="flex justify-between items-center max-lg:flex-col max-lg:gap-y-2">
                        ...
                        <button
                            ...
                            className="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg flex items-center gap-2 transition-colors ml-auto"
                        >
                            <FaPlus size={16} />
                            Create Campaign
                        </button>
